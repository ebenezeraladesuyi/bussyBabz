...
import nnpp from "../../../assets/images/nnpp.jpg";

const AboutCand = () => {
  return (
    <div className="w-full min-h-[40vh] flex items-cente justify-center py-[40px] overflow-hidden bg-black">
      <div className="w-[90%] flex flex-col justify-cente items-center">
        <h1 className="text-[20px] md:text-[30px] lg:text-[40px] text-white font-bold text-center ">ABOUT CANDIDATES</h1>
