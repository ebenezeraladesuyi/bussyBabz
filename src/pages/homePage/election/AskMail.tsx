            ...
            <div className="w-[90%] flex flex-col z-20 gap-4 items-center mt-[60px]">
                ...
                <form onSubmit={handleVote} className="w-full md:w-[60%] lg:w-[40%] flex flex-col gap-5 bg-whit p-7 rounded-lg">
                    ...
                    <div className="w-full flex flex-col gap-3 items-center">
                        ...
                        {['LUCKY AIYEDATIWA (APC)', 'AGBOOLA AJAYI (PDP)', 'AYODELE FESTUS OLORUNFEMI (LP)', 'OLUGBENGA OMOGBEMI EDEMA (NNPP)'].map((candidate) => (
                            <div key={candidate} className="flex gap-3 items-center mb-[10px]">
                                <input
                                ...
                                />
                                <h2 className="text-[17px] md:text-[23px] text-white font-bold">{candidate}</h2>
                            </div>
                        ))}
                    </div>
